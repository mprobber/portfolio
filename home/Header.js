...
function makeName() {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    for (let j = 0; j < 12; j++) {
      row.push(
        <div className={letters[i][j] ? styles.litItem : styles.gridItem
      } key={j}/>);
    }
    all.push(
